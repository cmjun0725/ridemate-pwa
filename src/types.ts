...
export interface RouteCandidate { id: string; title: string; summary: string; distanceKm: number; elevationM: number; climbRate: number; distanceDifferenceKm: number; coordinates: Coordinate[]; elevationProfile: ElevationPoint[]; verified: boolean }
